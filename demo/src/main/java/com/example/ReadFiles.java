...
public class ReadFiles {
    ...
    .forEach(p -> {
        //Salva o nome do arquivo sem a extenção
        ...
        if (fileNameWithoutExtension.indexOf(".") > 0)
            ...
            //Salva o path do arquivo sem a extenção
        String filePathWithoutExtension = p.toString();
        if (filePathWithoutExtension.indexOf(".") > 0)
            filePathWithoutExtension = filePathWithoutExtension.substring(0, filePathWithoutExtension.lastIndexOf("."));
